...
namespace Udger.Parser
{
    public class UserAgent
    {
        ...
        [NamePosition(44, Name = "Sec-Ch-Ua")]
        public string SecChUa { get; set; }

        [NamePosition(45, Name = "SecChUaFullVersionList")]
        public string SecChUaFullVersionList { get; set; }

        [NamePosition(46, Name = "SecChUaMobile")]
        public string SecChUaMobile { get; set; }

        [NamePosition(47, Name = "SecChUaFullVersion")]
        public string SecChUaFullVersion { get; set; }

        [NamePosition(48, Name = "SecChUaPlatform")]
        public string SecChUaPlatform { get; set; }

        [NamePosition(49, Name = "SecChUaPlatformVersion")]
        public string SecChUaPlatformVersion { get; set; }

        [NamePosition(51, Name = "SecChUaModel")]
